let originalNums = [4, 5, -5556, 155, 640, '15x', 6789, -5564, 478, 654, 'obuolys', 789, -51, 55, -222, 0, -357, -56, 'trylika', 444, 7778, 4154, 4751];
...
let filteredNums48 = originalNums.filter(function (num) {
    return num % 5 === 0 && num > 100 && num < 500
})
...
let filteredNums49 = originalNums.filter(function (num) {
    return num % 2 === 0 && num >= 888 && num < 1000
})
...
let filteredNums50 = originalNums.filter(function (num) {
    return num % 3 === 0 && num > -333 && num <= 888
})
...
let filteredNums62 = originalNums.filter(function (num) {
    return typeof num === "string" && num.includes(`t` * 2)
...
let filteredNums63 = originalNums.filter(function (num) {
    return typeof num === "string" && num.includes('s' + 't')
...
let filteredNums64 = originalNums.filter(function (num) {
    return typeof num === "string" && num.includes('n' + 'd')
...
let filteredNums68 = originalNums.filter(function (num) {
    return typeof num === "string" && num.charAt(0) === "1"
})
...
let filteredNums69 = originalNums.filter(function (num) {
    return typeof num === "string" && num.charAt(0) === "s"
})
...
let filteredNums70 = originalNums.filter(function (num) {
    return typeof num === "string" && num.charAt(0) === "o"
})
...
let filteredNums71 = originalNums.filter(function (num) {
    return typeof num === "string" && num.charAt(num.length - 1) === "s"
})
...
let filteredNums72 = originalNums.filter(function (num) {
    return typeof num === "string" && num.includes`o` && num.length > 4
})
...
let filteredNums73 = originalNums.filter(function (num) {
    return typeof num === "string" && num.includes`a` && num.length >= 5
})
...
let filteredNums76 = originalNums.filter(function (num) {
    return typeof num === "string" && num.length % 2 !== 0 && num.includes`s`
})
...
let filteredNums79 = originalNums.filter(function (num) {
    return typeof num === "string" && num.charAt(0) !== "t" && num.length > 4
})
...
let filteredNums80 = originalNums.filter(function (num) {
    return typeof num === "string" && num.charAt(0) !== "e" && num.length < 6 && num.charAt(0) === NaN
})
console.log(filteredNums80)
